...
|--------|--------|-------|-------------------|
|  | [Dark Matter and Dark Energy](https://en.wikipedia.org/wiki/Dark_matter) | Cosmology | 1970s |
...
|  | [Interpretations of Quantum Mechanics](https://en.wikipedia.org/wiki/Interpretations_of_quantum_mechanics) | Physics | 1920s |
|| **Description:** There are various perspectives on interpreting quantum mechanics, such as the Copenhagen interpretation and the many-worlds interpretation, which have not yet been experimentally verified. | 코펜하겐 해석, 다세계 해석 등 양자역학을 해석하는 다양한 관점이 존재하며, 아직 실험으로 검증되지 않은 상태입니다. |
...
|| **Description:** The development of technology to stably control nuclear fusion and produce energy has not yet been completed. | 핵융합을 안정적으로 제어하여 에너지를 생산하는 기술 개발이 아직 완료되지 않았습니다. |
|  | [Directionality of Evolution](https://en.wikipedia.org/wiki/Evolution) | Evolutionary Biology | 19th century |
|| **Description:** There are questions about whether evolution proceeds with a specific directionality and what drives it. | 진화가 특정한 방향성을 가지고 진행되는 것인지, 그리고 그 원동력이 무엇인지에 대한 의문이 있습니다. |
|  | [Fundamental Particles](https://en.wikipedia.org/wiki/Elementary_particle) | Particle Physics | Early 20th century |
|| **Description:** Even after the discovery of the Higgs boson, it is expected that there are smaller fundamental particles that make up matter. | 힉스 보손 발견 이후에도 물질을 구성하는 더 작은 기본 입자가 존재할 것으로 예상됩니다. |
|  | [String Theory](https://en.wikipedia.org/wiki/String_theory) | Physics | 1960s |
|| **Description:** String theory is one of the attempts to unify quantum mechanics and general relativity, but it has not yet been experimentally verified. | 끈 이론은 양자역학과 일반 상대성 이론을 통합하려는 시도 중 하나이지만, 아직 실험적으로 검증되지 않았습니다. |
|  | [Protein Folding](https://en.wikipedia.org/wiki/Protein_folding) | Biophysics | 1950s |
|| **Description:** There is still a lack of understanding of how proteins fold into unique tertiary structures and how this relates to protein function. | 단백질이 어떻게 독특한 3차 구조로 접히는지, 그리고 이것이 단백질 기능과 어떻게 연관되는지에 대한 이해가 여전히 부족합니다. |
|  | [Earth's Magnetic Field](https://en.wikipedia.org/wiki/Earth%27s_magnetic_field) | Geophysics | Early 20th century |
|| **Description:** It is not fully understood how Earth's magnetic field formed and how it relates to convection in the core. | 지구 자기장이 어떻게 형성되었는지, 그리고 지구 핵에서의 대류와 어떤 관련이 있는지 완전히 이해되지 않았습니다. |
|  | [The Origin and Evolution of the Universe](https://en.wikipedia.org/wiki/Universe) | Cosmology | Early 20th century |
|| **Description:** There are various theories about how the universe has evolved since the Big Bang and what the future of the universe will be like. | 빅뱅 이후 우주가 어떻게 진화해 왔는지, 그리고 우주의 미래가 어떨지에 대한 다양한 이론이 있습니다. |
|  | [Superconductivity Mechanisms](https://en.wikipedia.org/wiki/Superconductivity) | Condensed Matter Physics | Early 20th century |
|| **Description:** There is still a lack of understanding of the fundamental principles behind the superconductivity phenomenon that occurs in some materials. | 일부 물질에서 발생하는 초전도 현상의 근본 원리에 대한 이해가 여전히 부족합니다. |
|  | [Earthquake Prediction](https://en.wikipedia.org/wiki/Earthquake_prediction) | Geophysics | Early 20th century |
...
|  | [Global Water Security](https://en.wikipedia.org/wiki/Water_security) | Environmental Science | 1970s | 2000s |
|| **Description:** Ensuring access to clean and sufficient water resources is vital for human survival, agriculture, and maintaining ecosystems. | 깨끗하고 충분한 수자원에 대한 접근을 보장하는 것은 인류의 생존, 농업 및 생태계 유지에 필수적입니다. |
|  | [Global Food Security](https://en.wikipedia.org/wiki/Food_security) | Agricultural Science | 1940s | 1960s |
|| **Description:** Ensuring sufficient, safe, and nutritious food for the growing global population is a critical challenge, requiring advancements in agriculture, distribution, and waste reduction. | 증가하는 세계 인구를 위해 충분하고 안전하며 영양가 있는 식량을 확보하는 것은 농업, 유통 및 폐기물 감소 분야의 발전이 필요한 중요한 과제입니다. |
|  | [Infectious Disease Prevention and Control](https://en.wikipedia.org/wiki/Infection_control) | Epidemiology | Late 19th century | 1920s |
|| **Description:** Preventing and controlling the spread of infectious diseases is crucial for public health and requires continuous research into vaccines, treatments, and containment strategies. | 감염병의 확산을 예방하고 통제하는 것은 공중 보건에 매우 중요하며, 백신, 치료법 및 억제 전략에 대한 지속적인 연구가 필요합니다. |
|  | [Antibiotic Resistance](https://en.wikipedia.org/wiki/Antimicrobial_resistance) | Microbiology | 1940s | 1960s |
|| **Description:** The growing resistance of bacteria to antibiotics poses a major threat to public health, requiring the development of new antibiotics and strategies to prevent the spread of resistant strains. | 항생제에 대한 박테리아의 내성 증가는 공중 보건에 큰 위협이 되며, 새로운 항생제 개발과 내성 균주의 확산을 방지하기 위한 전략이 필요합니다. |
|  | [Cancer Prevention and Treatment](https://en.wikipedia.org/wiki/Cancer) | Oncology | Early 20th century | 1940s |
...
|  | [Personalized Medicine and Genomics](https://en.wikipedia.org/wiki/Personalized_medicine) | Genomics | 1990s | 2000s |
|| **Description:** Personalized medicine tailors medical treatments to an individual's genetic profile, potentially improving treatment efficacy and reducing adverse effects. | 맞춤 의학은 개인의 유전적 프로필에 맞춰 의학적 치료를 조정하여 치료 효과를 높이고 부작용을 줄일 수 있습니다. |
|  | [Stem Cell Therapy](https://en.wikipedia.org/wiki/Stem-cell_therapy) | Regenerative Medicine | 1960s | 1990s |
|| **Description:** Stem cell therapy has the potential to treat a wide range of diseases and injuries by regenerating damaged tissues and organs, but ethical and safety concerns need to be addressed. | 줄기세포 치료는 손상된 조직과 장기를 재생함으로써 다양한 질병과 상해를 치료할 수 있는 잠재력을 가지고 있지만, 윤리적 문제와 안전성에 대한 우려는 해결되어야 합니다. |
|  | [Immunotherapy and Cancer Treatment](https://en.wikipedia.org/wiki/Immunotherapy) | Oncology | 1890s | 1980s |
|| **Description:** Immunotherapy harnesses the power of the immune system to fight cancer, offering a promising alternative to traditional treatments like chemotherapy and radiation. | 면역요법은 암과 싸우기 위해 면역 체계의 힘을 활용하여 화학요법과 방사선과 같은 전통적인 치료법에 대한 유망한 대안을 제공합니다. |
